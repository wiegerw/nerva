...
../tools/dist/mlpf --seed=1 --overall-density=0.001 --sizes=3072,1024,1024,1024,10 --batch-size=100 --epochs=3 '--learning-rate=constant(0.1)' '--optimizer=nesterov(0.9)' --layers=TTTL --weights=pppp --loss=softmax-cross-entropy --threads=4 --no-shuffle --verbose --dataset=cifar10 2>&1 | tee issue1c.log
