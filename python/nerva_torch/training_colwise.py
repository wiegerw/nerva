...
from nerva_torch.learning_rate import parse_learning_rate, LearningRateScheduler
from nerva_torch.datasets import DataLoader, create_npz_dataloaders
from nerva_torch.loss_functions_colwise import *
from nerva_torch.multilayer_perceptron_colwise import MultilayerPerceptron
from nerva_torch.parse_mlp_colwise import parse_multilayer_perceptron, parse_loss_function
from nerva_torch.utilities import pp, set_numpy_options, set_torch_options, StopWatch
from nerva_torch.training import SGDOptions, print_epoch
...
def compute_accuracy(M: MultilayerPerceptron, data_loader: DataLoader):
    ...
    for X, T in data_loader:
        ...
        targets = T.argmax(dim=0)    # the expected classes
