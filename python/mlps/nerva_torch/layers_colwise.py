...
from mlps.nerva_torch.matrix_operations import column_repeat, columns_sum, diag, elements_sum, hadamard, \
...
from mlps.nerva_torch.softmax_functions import log_softmax_colwise, softmax_colwise
