...
from symbolic.nerva_tensorflow.activation_functions import *
from symbolic.nerva_tensorflow.optimizers import CompositeOptimizer
from symbolic.nerva_tensorflow.parse_mlp import parse_optimizer
from symbolic.nerva_tensorflow.softmax_functions import *
from symbolic.nerva_tensorflow.weight_initializers import set_layer_weights
...
class BatchNormalizationLayer(Layer):
    ...
    def backpropagate(self, Y: Matrix, DY: Matrix) -> None:
        ...
        DX = hadamard(row_repeat(power_minus_half_Sigma / N, N), (N * identity(N) - ones(N, N)) @ DZ - hadamard(Z, row_repeat(diag(tf.transpose(Z) @ DZ), N)))
