...
from symbolic.tensorflow.utilities import pp
    ...
    def info(self):
        ...
        for layer in self.layers:
            if isinstance(layer, LinearLayer):
                ...
                pp(f'b{index}', tf.transpose(layer.b))  # TODO: avoid the transpose
                index += 1
    ...
    def load_weights_and_bias(self, filename: str):
        ...
        for layer in self.layers:
            if isinstance(layer, LinearLayer):
                ...
                layer.b.assign(to_col(data[f'b{index}']))  # TODO: fix the to_col
                index += 1
