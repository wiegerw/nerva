...
# Nerva-c++
../tools/dist/mlpf --seed=1 --overall-density=0.05 --hidden='1024,512' --batch-size=100 --epochs=1 --learning-rate='constant(0.1)' --optimizer='nesterov(0.9)' --architecture=RRL --weights=xxx --dataset=cifar10 --size=50000 --loss=softmax-cross-entropy --algorithm=minibatch --threads=4 --no-shuffle -v

# Nerva-c++ preprocessed
../tools/dist/mlpf --seed=1 --overall-density=0.05 --hidden='1024,512' --batch-size=100 --epochs=1 --learning-rate='constant(0.1)' --optimizer='nesterov(0.9)' --architecture=RRL --weights=xxx --dataset=cifar10 --preprocessed=./cifar1 --size=50000 --loss=softmax-cross-entropy --algorithm=minibatch --threads=4 --no-shuffle -v
