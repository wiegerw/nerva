...
{
  eigen::matrix Y {    {3.74540181, 9.50714311, 7.31993969},
...
{
  eigen::matrix Y {    {6.80307571, 4.50499307, 0.13265060},
...
{
  eigen::matrix Y {    {6.62522318, 3.11711145, 5.20068069},
...
{
  eigen::matrix Y {    {3.88677351, 2.71349105, 8.28737526},
