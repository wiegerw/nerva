...
{
  eigen::matrix Y {    {3.74540181, 9.50714311, 7.31993969, 5.98658524},
    {1.56018725, 1.55994605, 0.58083706, 8.66176159},
    {6.01115052, 7.08072607, 0.20584592, 9.69909855},
  };

  eigen::matrix T {    {0.00000000, 0.00000000, 0.00000000, 1.00000000},
...
{
  eigen::matrix Y {    {0.00778866, 9.92211560, 6.17481548, 6.11653199},
...
{
  eigen::matrix Y {    {5.14234487, 5.92414610, 0.46450508, 6.07544891},
    {1.70524207, 0.65051686, 9.48885542, 9.65632037},
    {8.08397367, 3.04613839, 0.97672204, 6.84233058},
  };

  eigen::matrix T {    {0.00000000, 0.00000000, 1.00000000, 0.00000000},
    {0.00000000, 0.00000000, 0.00000000, 1.00000000},
    {0.00000000, 0.00000000, 1.00000000, 0.00000000},
  };
...
{
  eigen::matrix Y {    {6.09996697, 8.33194928, 1.73364736, 3.91060668},
...
{
  eigen::matrix Y {    {5.97900019, 9.21874243, 0.88492593, 1.95982943},
    {0.45227384, 3.25330398, 3.88677351, 2.71349105},
    {8.28737526, 3.56753391, 2.80934582, 5.42696129},
  };

  eigen::matrix T {    {1.00000000, 0.00000000, 0.00000000, 0.00000000},
